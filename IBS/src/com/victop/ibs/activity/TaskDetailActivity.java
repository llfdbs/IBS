...
public class TaskDetailActivity extends ActivityBase {
	...
	private TextView tv_taskdetail_title,tv_taskdetail_detail,tv_taskdetail_tasknumber,
	tv_taskdetail_deadline,tv_taskdetail_tasktype,tv_taskdetail_taskobj,tv_taskdetail_taskstatue,tv_materialcount;
	private String str_taskdetail_title,str_taskdetail_detail,str_taskdetail_tasknumber,
	str_taskdetail_deadline,str_taskdetail_tasktype,str_taskdetail_taskobj,str_taskdetail_taskstatue,str_materialcount;
	@Override
	...
	protected void initData() {
		// TODO Auto-generated method stub
	  setData();
      adapter = new TaskDetail_MaterialAdapter(TaskDetailActivity.this, listData);
